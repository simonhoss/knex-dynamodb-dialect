...
var DynamoDBDialect = /** @class */ (function (_super) {
        ...
        if (obj.dynamodb) {
            return new Promise(function (resolve) {
                obj.dynamodb.exec(function (err, res) {
                    ...
                    if (res && res.Items) {
                        resolve({ Items: res.Items.map(function (item) { return item.attrs; }) });
                        return;
                    }
                    resolve(res);
                });
    ...
    DynamoDBDialect.prototype.queryCompiler = function () {
        return new (compiler_1.DynamoDBQueryCompiler.bind.apply(compiler_1.DynamoDBQueryCompiler, __spread([void 0, this], arguments)))();
    };
    DynamoDBDialect.prototype.schemaCompiler = function () {
        return new (compiler_2.DynamoDBSchemaCompiler.bind.apply(compiler_2.DynamoDBSchemaCompiler, __spread([void 0, this], arguments)))();
    };
    DynamoDBDialect.prototype.tableCompiler = function () {
        return new (tablecompiler_1.DynamoDBTableCompiler.bind.apply(tablecompiler_1.DynamoDBTableCompiler, __spread([void 0, this], arguments)))();
    };
    DynamoDBDialect.prototype.columnCompiler = function () {
        return new (columncompiler_1.DynamoDBColumnCompiler.bind.apply(columncompiler_1.DynamoDBColumnCompiler, __spread([void 0, this], arguments)))();
    };
    DynamoDBDialect.prototype.transaction = function () {
        return new (transaction_1.default.bind.apply(transaction_1.default, __spread([void 0, this], arguments)))();
    };
    DynamoDBDialect.prototype.acquireRawConnection = function () {
        if (this.connectionSettings.region &&
            this.connectionSettings.endpoint) {
            this.driver.config.region = this
                .connectionSettings.region;
            this.driver.config.endpoint = this
